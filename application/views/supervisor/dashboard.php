        ...
        <div class="container">
            <div class="row justify-content-center justify-content-xl-start">
                <div class="col-xl-10 align-self-center">
                    ...
                    <div class="btn-area">
                        <a class="btn btn-border-white page-scroll" href="#demo">View Demos</a>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <div class="section-title">
                        ...
                        <h2 class="title">Pembuatan Akun Operator</h2>
                    </div>
                </div>
            </div>
            <!-- <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="inner-item style-large">
                        <a href="index-1.html"><span class="thumb"><img
                                    src="https://solverwp.com/demo/html/edumint/demo-landing/img/1.jpg"
                                    alt="img"></span>Home V.1</a>
                        <a class="btn btn-base" href="index-1.html" target="_blank">Live Demo</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="inner-item style-large">
                        <a href="index-2.html"><span class="thumb"><img
                                    src="https://solverwp.com/demo/html/edumint/demo-landing/img/2.jpg"
                                    alt="img"></span>Home V.2</a>
                        <a class="btn btn-base" href="index-2.html" target="_blank">Live Demo</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="inner-item style-large">
                        <a href="index-3.html"><span class="thumb"><img
                                    src="https://solverwp.com/demo/html/edumint/demo-landing/img/3.png"
                                    alt="img"></span>Home V.3</a>
                        <a class="btn btn-base" href="index-2.html" target="_blank">Live Demo</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="inner-item style-large coming-soon">
                        <a href="#"><span class="thumb"><img
                                    src="https://solverwp.com/demo/html/edumint/demo-landing/img/2.png"
                                    alt="img"></span><span class="cm-soon-title">Comming Soon</span></a>
                    </div>
                </div>
            </div> -->

            <!-- <div class="" style="background-color: #fff; height:5rem;">
                <div style="margin-left: 40px ;" class="input-group">
                    <div style="margin-top: 1rem;" class="form-outline">
                        <input id="search-focus" type="search" id="form1" class="form-control" />
                      
                    </div>
                    <button style="height: 2.4rem; margin-top: 1rem;" type="button" class="btn btn-primary">
