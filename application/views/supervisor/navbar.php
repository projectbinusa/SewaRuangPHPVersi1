            ...
            <div class="container nav-container">
                ...
                <div  class="collapse navbar-collapse" id="alamgir_main_menu">
                    <ul  class="navbar-nav menu-open text-center m-auto">
                        ...
                        <li>
                            <a style="color: white;" class="page-scroll" href="#demo">Demos</a>
                        </li>
                        <li>
                            <a style="color: white;" class="page-scroll" href="#widget">Laporan</a>
                        </li>
                        <li>
                            <a style="color: white;" class="page-scroll" href="#forget">Forget password</a>
                        </li>
                        <li>
