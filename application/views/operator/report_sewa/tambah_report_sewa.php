                                ...
                                <tbody>
                                    ...
                                    foreach ($peminjaman as $row) : $no++ ?>
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <!-- Ruangan -->
                                            <td data-cell="Ruangan" class="text-center w-32 px-3 py-4">
                                            ...
                                            <!-- Kode Booking -->
                                            <td data-cell="Kode" class="text-center w-36 px-3 py-4">
                                            ...
                                            <!-- Total Booking -->
                                            <td class="text-center w-32 px-3 py-4">
                                                <?php
                                            ...
                                            <!-- Total -->
                                            <td data-call="Total Booking" class="text-center w-32 px-3 py-4">
                                                <?php echo $row->total_harga ?>
                                            </td>
                                            <!-- Status -->
                                            <td data-cell="Status" class="text-center w-32 px-3 py-4">
                                                <?php echo $row->status ?>
                                            </td>
                                            <!-- Aksi -->
                                            <td class="justify-content-center px-3 py-4 flex">
                                                <a href="<?php echo base_url('operator/update_report_sewa') ?>" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-3 rounded">
                                                    <span class="">
