      ...
      <h1 class="text-4xl font-bold mb-2 text-gray-900 dark:text-white flex items-center gap-3">
        ...
        <div class="ml-auto">
          <div class="items-center justify-between w-full mb-4">
            ...
            <a href="tambah_ruang" class="ml-2 inline-block px-4 py-2 bg-blue-500 hover:bg-blue-700 text-white font-semibold text-base rounded" onclick="showAddConfirmation()">
