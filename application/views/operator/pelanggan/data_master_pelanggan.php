...
<div class="container w-full md:w-4/4 xl:w-4/7  mx-auto px-6">
    ...
    <h1 class="text-2xl font-bold mb-2 text-gray-900 dark:text-white flex items-center">
       ...
       <a href="import_pelanggan" class="ml-auto inline-block px-4 py-2 bg-blue-700 hover:bg-blue-500 text-white font-semibold text-base rounded shadow-md transition duration-300 ease-in-out transform hover:scale-105" 
       onclick="showAddConfirmation()">
        <button>
            Import
        </button>
