...
<?php $this->load->view('sidebar'); ?>
      ...
      <div class="p-8 w-full md:w-5/6 lg:w-3/4 xl:w-1/2 flex justify-center items-center">
        <div class="w-full mx-auto">
          ...
          <?php foreach ($ruang as $row) : ?>
  <div class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow-lg md:flex-row md:max-w-4xl hover:bg-blue-500 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
