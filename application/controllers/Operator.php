...
class operator extends CI_Controller
{
    ...
    public function aksi_tambah_ruangan()
    {
        ...
        if (empty($no_lantai) || !is_numeric($no_lantai)) {
            $errors[] = 'Nomor Lantai harus berupa angka.';
        }

        if (empty($no_ruang) || !is_numeric($no_ruang)) {
            $errors[] = 'Nomor Ruangan harus berupa angka.';
        }
                ...
                if (!empty($image)) {
                    ...
                    if (move_uploaded_file($foto_temp, $upload_path)) {
                        ...
                        $response = [
                            ...
                            'redirect' => base_url('operator/ruang/ruang/Data_Ruangan'), // Redirect ke halaman daftar ruangan jika berhasil
                        ];
                    } else {
                    ...
                    $response = [
                        ...
                        'redirect' => base_url('operator/ruang/ruang/edit_ruangan/' . $id), // Redirect ke halaman edit jika validasi gagal
                    ];
                }
